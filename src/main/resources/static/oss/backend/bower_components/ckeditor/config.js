...
CKEDITOR.editorConfig = function( config ) {
	...
	config.contentsCss = ['https://cdn.ckeditor.com/4.8.0/full-all/contents.css', 'mystyles.css' ];
    ...
    config.uploadUrl = '/api/v1/account/images';
    config.filebrowserImage2UploadUrl = '/upload';

	config.extraPlugins = 'tableresize,uploadimage,uploadfile,codesnippet';
